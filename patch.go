...
func patchFrontPars() *fixture.Group {
	...
	// fixture address is
	par1 := fixture.NewFixture(1, 114, 8, "shehds-par")
	fg.AddFixture("left_middle_par", par1)

	// right middle par
	par2 := fixture.NewFixture(2, 138, 8, "shehds-par")
...
func patchUplightPars() *fixture.Group {
	...
	par3 := fixture.NewFixture(3, 122, 8, "shehds-par")
	fg.AddFixture("left_uplight_par", par3)

	// right uplight par (A.131 -> 130)
	par4 := fixture.NewFixture(3, 130, 8, "shehds-par")
