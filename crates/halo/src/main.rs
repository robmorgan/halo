        ...
        cues: vec![
            ...
            Cue {
                ...
                static_values: static_values![
                    (2, ChannelType::Dimmer, 255),
                    (2, ChannelType::Color, 255),
                    (2, ChannelType::Strobe, 180),
                ],
                effects: vec![],
            },
            Cue {
                ...
                fade_time: Duration::from_secs(5),
                is_blocking: false,
                timecode: Some("00:01:20:00".to_string()),
                static_values: static_values![
                    (2, ChannelType::Dimmer, 255),
                    (2, ChannelType::Color, 255),
                    (2, ChannelType::Strobe, 180),
                    (2, ChannelType::Pan, 127),
                    (2, ChannelType::Tilt, 127),
                ],
                effects: vec![],
            },
            Cue {
                ...
                fade_time: Duration::from_secs(5),
                is_blocking: false,
                timecode: Some("00:04:02:00".to_string()),
                static_values: static_values![
                    (2, ChannelType::Dimmer, 255),
                    (2, ChannelType::Color, 80),
                    (2, ChannelType::Strobe, 180),
                    (2, ChannelType::Pan, 127),
                    (2, ChannelType::Tilt, 127),
                ],
